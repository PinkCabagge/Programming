...
namespace Lab8_2
{
    ...
    {
        public static Entities.FederationSubject<int> altairegion = new Entities.FederationSubject<int>(22, "Барнаул", "Алтайский край", 30, 300, 10);
        public Form1()
        {
            InitializeComponent();
        ...
        {
            this.textBox1.Text = String.Format("{0}", altairegion);
        }
    }
}
